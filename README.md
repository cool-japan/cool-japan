![Crates](https://img.shields.io/badge/crates-684-orange)
...
The official COOLJAPAN Pure Rust Ecosystem — 684 crates, ~28M SLoC, zero C/FFI (in default) · Memory-safe by design.
...
- **Total crates**: 684 (and growing daily)
