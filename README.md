![Crates](https://img.shields.io/badge/crates-631-orange)
...
The official COOLJAPAN Pure Rust Ecosystem — 631 crates, ~26M SLoC, zero C/FFI (in default) · Memory-safe by design.
...
- **Total crates**: 631 (and growing daily)
...
| **LLM**                           | OxiBonsai          | Pure Rust 1-Bit LLM Inference Engine for PrismML Bonsai Models              | [→](https://github.com/cool-japan/oxibonsai) |
...
| ...                               | 30+ more projects  | Full ecosystem overview at [cooljapan.tech](https://cooljapan.tech)                                   | — |
